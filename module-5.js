...
//   console.log(`обробляємо помилку від ${callback()}`);
// }
...
//   return `${clientName}, nice to see you in '${this.service}!'`;
// }
// const steam = {
//   service: "Steam",
// };
...
// function makeMessage(callback) {
//   console.log(`обробляю заявку від ${callback()}`);
// }
// // makeMessage(customer.getFullName);-не коректний виклик
...
// console.log(pizzaPalace.order("Chees"));
